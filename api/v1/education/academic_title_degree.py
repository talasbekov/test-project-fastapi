...
router = APIRouter(prefix="/academic_title_degrees", tags=["AcademicTitleDegrees"], dependencies=[Depends(HTTPBearer())])
...
async def get_all(*,
    ...
    """
        ...
        - **skip**: int - The number of AcademicTitleDegrees to skip before returning the results. This parameter is optional and defaults to 0.
        - **limit**: int - The maximum number of AcademicTitleDegrees to return in the response. This parameter is optional and defaults to 100.
    """
...
async def help(*,
    db: Session = Depends(get_db)):
    academic_title_degree_service.add_AcademicTitleDegree(db, AcademicTitleDegreeCreate(name="test", url="sad"))
