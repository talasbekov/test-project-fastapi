...
from schemas.education import AcademicDegreeCreate, AcademicDegreeRead, AcademicDegreeUpdate
from services.education import academic_degree_service

router = APIRouter(prefix="/academic_degrees", tags=["AcademicDegrees"], dependencies=[Depends(HTTPBearer())])
...
async def get_all(*,
    ...
    """
        ...
        - **skip**: int - The number of AcademicDegrees to skip before returning the results. This parameter is optional and defaults to 0.
        - **limit**: int - The maximum number of AcademicDegrees to return in the response. This parameter is optional and defaults to 100.
    """
...
async def update(*,
    ...
    """
        ...
        - **id**: UUID - the ID of AcademicDegree to update. This is required.
        - **name**: required.
        - **url**: image url. This parameter is required.
    """
    Authorize.jwt_required()
...
async def help(*,
    db: Session = Depends(get_db)):
    academic_degree_service.add_AcademicDegree(db, AcademicDegreeCreate(name="test", url="sad"))
