...
async def get_by_user_id(
    *, db: Session = Depends(get_db), user_id: str, auto_tag: str, Authorize: AuthJWT = Depends()
):
    ...
    Args:
        ...
        db (Session, optional): Instance of Session for database connection. Defaults to Depends(get_db).
