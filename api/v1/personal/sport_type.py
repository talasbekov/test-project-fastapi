...
async def get_all(*,
    ...
    """
        ...
        - **skip**: int - The number of SportType to skip before returning the results. This parameter is optional and defaults to 0.
        - **limit**: int - The maximum number of SportType to return in the response. This parameter is optional and defaults to 100.
    """
    Authorize.jwt_required()
    return sport_type_service.get_multi(db, skip, limit)
