...
async def get_by_id(*,
    ...
    """
    Authorize.jwt_required()
    return education_service.get_by_id(db, str(id))
...
async def update(*,
    ...
    """
    Authorize.jwt_required()
    education = education_service.get_by_id(db, str(id))
    body.profile_id = education.educational_profile_id
...
async def delete(*,
    ...
    """
    Authorize.jwt_required()
    education_service.remove(db, str(id))
