...
router = APIRouter(prefix="/educations", tags=["Educations"], dependencies=[Depends(HTTPBearer())])
...
async def help(*,
    db: Session = Depends(get_db)):
    education_service.add_Education(db, EducationCreate(name="test", url="sad"))
