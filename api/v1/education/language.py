...
async def get_all(*,
    ...
    return language_service.get_all(db, skip, limit, filter)
...
async def get_by_id(*,
    ...
    """
    Authorize.jwt_required()
    return language_service.get_by_id(db, str(id))
...
async def update(*,
    ...
    return language_service.update(
        db,
        db_obj=language_service.get_by_id(db, str(id)),
        obj_in=body)
...
async def delete(*,
    ...
    """
    Authorize.jwt_required()
    language_service.remove(db, str(id))
