...
from schemas import JurisdictionRead, ServiceStaffFunctionTypeRead, NamedModel, CustomBaseModel
...
class ArchiveStaffUnitFunctions(CustomBaseModel):
    staff_unit_id: str
...
class ArchiveDocumentStaffFunctionTemplate(CustomBaseModel):
...
class ArchiveDocumentStaffFunctionStep(CustomBaseModel):
