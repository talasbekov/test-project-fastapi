...
router = APIRouter(prefix="/surveys", tags=["Surveys"], dependencies=[Depends(HTTPBearer())])
...
async def get_all(*,
    ...
    """
        ...
        - **skip**: int - The number of surveys to skip before returning the results. This parameter is optional and defaults to 0.
        - **limit**: int - The maximum number of surveys to return in the response. This parameter is optional and defaults to 100.
    """
    Authorize.jwt_required()
    return survey_service.get_multi(db, skip, limit)
