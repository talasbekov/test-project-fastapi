...
from schemas import (BadgeRead, RankRead, ReadModel,
                     StaffUnitHrVacancyRead, Model, PositionRead, CustomBaseModel)
...
class ArchiveStaffUnitBase(CustomBaseModel):
...
class ArchiveStaffUnitUpdateDispose(CustomBaseModel):
...
class ArchiveStaffUnitReadPagination(CustomBaseModel):
    total: Optional[int]
