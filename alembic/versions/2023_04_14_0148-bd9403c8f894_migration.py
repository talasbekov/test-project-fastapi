...
def upgrade() -> None:
    ...
    op.bulk_insert(
        ...
        [{
            ...
            'name': "Вся служба",
            'nameKZ': 'Барлық қызмет',
            'description': '''Департамент управления финансами отвечает за управление и ведение учета финансовых операций компании. Он отвечает за сбор, анализ и отчетность о всех финансовых операциях, производимых внутри компании.Задачи департамента финансов включают в себя следующее:
...
Составление отчетности о финансовом положении компании и подготовка отчетов для внешних заинтересованных сторон.
    Департамент финансов должен иметь высокую квалификацию сотрудников, занимающихся финансовыми вопросами, и использовать передовые методы управления и анализа данных. Он должен тесно сотрудничать с другими департаментами компании, чтобы обеспечить наилучшие результаты в рамках общей стратегии компании.''',
            'descriptionKZ': '''Қаржыны басқару департаменті компанияның қаржылық операцияларын басқаруға және есепке алуға жауапты. Ол компания ішінде жасалатын барлық қаржылық операцияларды жинауға, талдауға және есеп беруге жауапты.Қаржы департаментінің міндеттері мыналарды қамтиды:
