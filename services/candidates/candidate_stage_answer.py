...
class CandidateStageAnswerService(
        ServiceBase[CandidateStageAnswer, CandidateStageAnswerCreate, CandidateStageAnswerUpdate]):
    ...
    def create_list(self, db: Session,
    ...
    def _set_status_to_current_stage_info(
            self, db: Session, candidate_id: str, candidate_stage_question_id: str, status: CandidateStageInfoStatusEnum):
