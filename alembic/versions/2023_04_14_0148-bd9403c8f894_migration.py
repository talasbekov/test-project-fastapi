                ...
                [
                    {
                        ...
                        'keys': {
                            'Требования к образованию': [
                                {
                                    "name": "Высшее профессиональное",
                                    "nameKZ": "Жоғары кәсіпкерлік"
                                },
                            ]
                        }
                    },
                    {
                        ...
                        'keys': {
                            'Требования к стажу': [
                                {
                                    "name": "10 лет стажа работы в правоохранительных, специальных государственных органах или на воинской службе",
                                    "nameKZ": "Құқық қорғау, арнаулы мемлекеттік органдарда немесе әскери қызметте 10 жыл жұмыс өтілі"
                                },
                                {
                                    "name": "4 года стажа работы на руководящих должностях",
                                    "nameKZ": "4 жыл басшы лауазымдардағы жұмыс өтілі"
                                }
                            ]
                        }
                    },
                    {
                        ...
                        'keys': {
                            'Практический опыт': [
                                {
                                    "name": "Наличие обязательных знаний, умений и навыков",
                                    "nameKZ": "Міндетті білімнің, іскерліктің және дағдылардың болуы"
                                },
                            ]
                        }
                    },
            ...
            'requirements':
                [
                    ...
                    },
                    {
                        ...
                        'nameKZ': 'Денсаулық талаптары',
                        'full_text': {
                            'name': 'Пригодность по состоянию здоровья для осуществления деятельности в СГО РК.',
                            'nameKZ': 'Денсаулық жағдайы бойынша Қазақстан Республикасының МКҚК-де қызметті жүзеге асыруға жарамдылығы.'}
                ...
                [
                    {
                        ...
                        'nameKZ': 'Білім талаптары',
                        'full_text': {
                            'name': 'Высшее профессиональное, соответствующее функциональным направлениям конкретной должности.',
                            'nameKZ': 'Белгілі бір лауазымның функционалдық бағыттарына сәйкес келетін жоғары кәсіби.'
                            }
                    },
                    {
                        'name': 'Требования к стажу',
                        'nameKZ': 'Тәжірибе талаптары',
                        'full_text': {
                            'name': '''Наличие не менее 10 лет стажа работы в правоохранительных, специальных государственных органах или на воинской службе, в том числе не менее 4 лет стажа работы на руководящих  должностях; либо не менее одиннадцати лет стажа работы на государственной службе, в том числе не менее 5 лет на руководящих должностях; либо не менее двенадцати лет стажа работы в сферах, соответствующих функциональным направлениям конкретной должности данной категории, в том числе не менее шести лет на руководящих должностях.''',
                            'nameKZ': '''Құқық қорғау, арнаулы мемлекеттік органдарда немесе әскери қызметте кемінде 10 жыл жұмыс өтілі, оның ішінде басшы лауазымдарда 4 жылдан кем емес жұмыс өтілі; немесе мемлекеттік қызметтегі жұмыс өтілі он бір жылдан кем емес, оның ішінде басшы лауазымдарда 5 жылдан кем емес; немесе осы санаттағы нақты лауазымның функционалдық бағыттарына сəйкес салаларда жұмыс өтілі он екі жылдан кем емес, оның ішінде басшы лауазымдарда алты жылдан кем емес.'''}
                    },
                    {
                        'name': 'Практический опыт',
                        'nameKZ': 'Практикалық тәжірибе',
                        'full_text': {
                            'name': 'Наличие обязательных знаний, умений и навыков, необходимых для исполнения функциональных обязанностей по данной должности.',
                            'nameKZ': 'Осы лауазымда функционалдық міндеттерді орындау үшін қажетті міндетті білімдердің, дағдылар мен дағдылардың болуы.'
                        }
                    },
                    {
                        'name': 'Требования по состоянию здоровья',
                ...
                [
                    {
                        'name': 'Требования к образованию',
                        'nameKZ': 'Білім талаптары',
                        'full_text': {'name': 'Высшее профессиональное, соответствующее функциональным направлениям конкретной должности.',
                                      'nameKZ': 'Белгілі бір лауазымның функционалдық бағыттарына сәйкес келетін жоғары кәсіби.'
                                     }
                    },
                    {
                    ...
                    },
                    {
                        'name': 'Требования по состоянию здоровья',
                        'nameKZ': 'Денсаулық талаптары',
                        'full_text': {'name': 'Пригодность по состоянию здоровья для осуществления деятельности в СГО РК.',
                                      'nameKZ': 'Денсаулық жағдайы бойынша Қазақстан Республикасының МКҚК-де қызметті жүзеге асыруға жарамдылығы.'}
