...
from .badge import BadgeCreate, BadgeUpdate, BadgeRead
...
from .hr_document import HrDocumentCreate, HrDocumentUpdate, HrDocumentRead, HrDocumentInit, HrDocumentSign
from .group import GroupCreate, GroupUpdate, GroupRead
from .hr_document_info import HrDocumentInfoCreate, HrDocumentInfoUpdate, HrDocumentInfoRead
