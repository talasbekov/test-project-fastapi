...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('ACTIVE', 'NOT_ACTIVE', 'DRAFT', name='surveystatusenum'), nullable=False),
    sa.Column('jurisdiction_type', sa.Enum('STAFF_DIVISION', 'CERTAIN_MEMBER', name='surveyjurisdictiontypeenum'), nullable=False),
