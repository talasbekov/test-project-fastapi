...
@router.get("", dependencies=[Depends(HTTPBearer())],
            response_model=List[InstitutionReadPagination],
...
async def get_all(*,
    ...
    return institution_service.get_all(db, skip, limit, filter)
...
async def get_by_id(*,
    ...
    """
    Authorize.jwt_required()
    return institution_service.get_by_id(db, str(id))
...
async def update(*,
    ...
    return institution_service.update(
        db,
        db_obj=institution_service.get_by_id(db, str(id)),
        obj_in=body)
...
async def delete(*,
    ...
    """
    Authorize.jwt_required()
    institution_service.remove(db, str(id))
