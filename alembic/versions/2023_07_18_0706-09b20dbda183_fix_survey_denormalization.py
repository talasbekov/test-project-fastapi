...
def downgrade() -> None:
    ...
    op.add_column('questions', sa.Column('quiz_id', sa.String(), autoincrement=False, nullable=True))
    ...
    sa.Column('certain_member_id', sa.String(), autoincrement=False, nullable=True),
    sa.Column('staff_division_id', sa.String(), autoincrement=False, nullable=True),
    sa.Column('owner_id', sa.String(), autoincrement=False, nullable=True),
