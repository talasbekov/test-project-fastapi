...
@router.get("", dependencies=[Depends(HTTPBearer())],
            response_model=AcademicTitleDegreeReadPagination,
...
async def get_all(*,
    ...
    return academic_title_degree_service.get_all(db, skip, limit, filter)
...
async def get_by_id(*,
    ...
    """
    Authorize.jwt_required()
    return academic_title_degree_service.get_by_id(db, str(id))
...
async def update(*,
    ...
    return academic_title_degree_service.update(
        db,
        db_obj=academic_title_degree_service.get_by_id(db, str(id)),
        obj_in=body)
...
async def delete(*,
    ...
    """
    Authorize.jwt_required()
    academic_title_degree_service.remove(db, str(id))
