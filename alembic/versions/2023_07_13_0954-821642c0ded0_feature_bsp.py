...
def upgrade() -> None:
    ...
    sa.Column('schedule_year_id', sa.String(), nullable=True),
    sa.Column('month_id', sa.String(), nullable=True),
    ...
    op.create_table('schedule_year_s_d',
    sa.Column('schedule_year_id', sa.String(), nullable=True),
    ...
    op.create_table('exam_schedule_inst',
    sa.Column('exam_schedule_id', sa.String(), nullable=True),
    sa.Column('user_id', sa.String(), nullable=True),
    ...
    op.create_table('schedule_month_instr',
    sa.Column('schedule_month_id', sa.String(), nullable=True),
    sa.Column('user_id', sa.String(), nullable=True),
    ...
    sa.Column('user_id', sa.String(), nullable=True),
    sa.Column('attendance_id', sa.String(), nullable=True),
    sa.Column('id', sa.String(length=36), nullable=False),
    sa.Column('created_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_table('schedule_month_instr')
    op.drop_table('schedule_days')
    op.drop_table('exam_schedule_inst')
    op.drop_table('exam_results')
    op.drop_table('attendances')
    op.drop_table('schedule_year_users')
    op.drop_table('schedule_year_s_d')
