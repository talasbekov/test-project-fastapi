...
@router.get("/has_permission", dependencies=[Depends(HTTPBearer())],
            response_model=bool,
...
async def has_permission(*,
    ...
    return permission_service.has_permission(db, str(user_id), permission_type)

@router.get("/user_permissions", dependencies=[Depends(HTTPBearer())],
...
async def update(*,
    ...
    return permission_service.update(
        db,
        db_obj=permission_service.get_by_id(db, str(id)),
        obj_in=body)
