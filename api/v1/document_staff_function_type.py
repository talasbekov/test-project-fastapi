...
async def get_by_id(*,
    ...
    """
    Authorize.jwt_required()
    return document_staff_function_type_service.get_by_id(db, str(id))
...
async def update(*,
    ...
    return document_staff_function_type_service.update(
        db,
        db_obj=document_staff_function_type_service.get_by_id(db, str(id)),
        obj_in=body)
...
async def delete(*,
    ...
    """
    Authorize.jwt_required()
    document_staff_function_type_service.remove(db, str(id))
